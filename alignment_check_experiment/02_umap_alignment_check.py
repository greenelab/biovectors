...
# This notebook is designed to test a potential issue with the Word2Vec alignment algorithm. In the notebook [03_word_decade_figure_generator_2000_2020.ipynb](https://github.com/greenelab/biovectors/blob/f04b9dae/word2vec_decade_experiment/03_word_decade_figure_generator_2000_2020.ipynb), words that shouldn't move a lot appear to be moving a lot within the early years (2000-2005). This led to the hypothesis that the alignment for word vectors doesn't work for the earlier years as there is a small amount of data. To see if there is an alignment issue I generated a umap plot of all tokens shared between 2000-2020 and color coded each point based on the year. Conclusion to be discussed at the bottom.
